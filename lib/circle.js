...
class Circle {
    ...
    circle() {
        return inquirer
            ...
            .then((answers) => {
                const svgContent = generateCircle(answers);
...
const generateCircle = ({acronym, letterColor, shapeColor}) => {
    return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"><circle cx ="150" cy="100" r="75" stroke="${shapeColor}" fill="${shapeColor}" stroke-width="1"/>
